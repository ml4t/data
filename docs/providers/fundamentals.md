...
| [S&P Capital IQ Financials](https://www.spglobal.com/market-intelligence/en/solutions/differentiated-data) | Global | **Yes**: Premium Financials carries filing dates for the full history and product delivery dates from 2004 | Yes: Capital IQ Estimates | Institutional (Capital IQ Pro, Xpressfeed, Snowflake); some via WRDS | No |
...
| [LSEG Worldscope](https://www.lseg.com/en/data-analytics/financial-data/company-data/fundamentals-data/worldscope-fundamentals) and [I/B/E/S](https://www.lseg.com/en/data-analytics/financial-data/company-data/ibes-estimates) (formerly Refinitiv, Thomson Reuters) | Worldscope: 100,000+ companies in 120+ countries, developed markets from 1980. I/B/E/S: North America from 1976, other markets from 1987 | **Yes**: point-in-time versions of both are offered | Yes: I/B/E/S | Institutional; academic via WRDS where licensed | No |
